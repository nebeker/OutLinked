...
public static class PromptSegments
{
    ...
    public const string Reply =
        "Write an insightful professional replyt to a professional social media post in 20 words or less. Explain the main point and add a piece of your own insight.";
    ...
    public const string AuthorInfo =
        "You are an experienced {title} in the {industry} industry with vast knowledge in the field.";

    public const string PlugContent =
        "At the end, make sure readers check your {type} called {title} available at {address}.";

    public const string UserPromptSeparator = "Don't divide your response into sections. The original post starts here:";

    public class Placeholders
    {
        public const string AuthorTitle = "{title}";
        public const string AuthorIndustry = "{industry}";
